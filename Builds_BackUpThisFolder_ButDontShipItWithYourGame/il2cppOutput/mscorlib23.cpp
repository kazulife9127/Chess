...
{
	YieldAwaiter_t32B66444215FB828BBC8DF4984069FBDA1DC12FE * _thisAdjusted;
	int32_t _offset = 1;
	_thisAdjusted = reinterpret_cast<YieldAwaiter_t32B66444215FB828BBC8DF4984069FBDA1DC12FE *>(__this + _offset);
	bool _returnValue;
...
IL_000e:
	...
	}
	{
		...
		NullCheck(L_9);
		VirtualActionInvoker2< SendOrPostCallback_t6B7334CE017AF595535507519400AC02D688DC3C *, RuntimeObject * >::Invoke(5 /* System.Void System.Threading.SynchronizationContext::Post(System.Threading.SendOrPostCallback,System.Object) */, L_9, L_10, L_11);
		return;
	}
